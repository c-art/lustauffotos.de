<?php /* Smarty version 2.6.10, created on 2006-11-15 13:40:44
         compiled from gallery:modules/core/templates/ItemEditItem.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_select_date', 'gallery:modules/core/templates/ItemEditItem.tpl', 132, false),array('function', 'html_select_time', 'gallery:modules/core/templates/ItemEditItem.tpl', 137, false),array('modifier', 'utf8', 'gallery:modules/core/templates/ItemEditItem.tpl', 135, false),)), $this); ?>
<div class="gbBlock">
...
<div class="gbBlock">
  ...
  <p class="giDescription">
    ...
    <?php else: ?>
      <?php echo $this->_reg_objects['g'][0]->text(array('text' => "Set the date and time to be displayed for this %s.",'arg1' => $this->_tpl_vars['ItemEditItem']['typeName']['1']), $this);?>

    <?php endif; ?>
  </p>

  <p>
    <?php ob_start();  echo '';  echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[originationTimestampSplit]"), $this); echo '';  $this->_smarty_vars['capture']['originationTimestampField'] = ob_get_contents(); ob_end_clean(); ?>
