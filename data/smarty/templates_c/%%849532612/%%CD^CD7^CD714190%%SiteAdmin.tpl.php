<?php /* Smarty version 2.6.10, created on 2006-11-15 13:23:15
...
">
		<?php if (( $this->_tpl_vars['SiteAdmin']['subViewName'] == $this->_tpl_vars['choice']['view'] )): ?>
		  <?php echo $this->_tpl_vars['choice']['name']; ?>

		<?php else: ?>
		  <a href="<?php echo $this->_reg_objects['g'][0]->url(array('arg1' => "view=core.SiteAdmin",'arg2' => "subView=".($this->_tpl_vars['choice']['view'])), $this);?>
">
		    <?php echo $this->_tpl_vars['choice']['name']; ?>
